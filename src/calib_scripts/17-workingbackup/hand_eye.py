...
class CameraCalibration:
    def __init__(self, image_folder, Transforms_folder, pattern_size=(6, 8), square_size=25/1000, ShowProjectError=False, ShowCorners=False):
...
if __name__ == "__main__":
    ...
    calib = CameraCalibration(image_folder, PoseFolder, ShowProjectError=False)
